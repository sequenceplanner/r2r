...
pub data: Vec<i8>,
            ...
            fn from_native(msg: &Self::CStruct) -> OccupancyGridUpdate {
  OccupancyGridUpdate {
...
pub points: sensor_msgs::msg::PointCloud2,
            ...
            fn from_native(msg: &Self::CStruct) -> PointCloud2Update {
  PointCloud2Update {
header: std_msgs::msg::Header::from_native(&msg.header),
type_: msg.type_,
...
pub max_z: f64,
            ...
            fn from_native(msg: &Self::CStruct) -> ProjectedMap {
  ProjectedMap {
...
pub max_z: f64,
            ...
            fn from_native(msg: &Self::CStruct) -> ProjectedMapInfo {
  ProjectedMapInfo {
...
max_z: msg.max_z,
            ...
            fn copy_to_native(&self, msg: &mut Self::CStruct) {msg.frame_id.assign(&self.frame_id);
msg.x = self.x;
msg.y = self.y;
msg.width = self.width;
msg.height = self.height;
...
sub_map: nav_msgs::msg::OccupancyGrid::from_native(&msg.sub_map),
            ...
            fn copy_to_native(&self, msg: &mut Self::CStruct) {self.sub_map.copy_to_native(&mut msg.sub_map);
}
...
let slice = unsafe { std::slice::from_raw_parts(msg.projected_maps_info.data, msg.projected_maps_info.size)};
for s in slice { temp.push(map_msgs::msg::ProjectedMapInfo::from_native(s)); }
temp },
      }
    }
            ...
            fn copy_to_native(&self, msg: &mut Self::CStruct) {unsafe { map_msgs__msg__ProjectedMapInfo__Sequence__fini(&mut msg.projected_maps_info) };
unsafe { map_msgs__msg__ProjectedMapInfo__Sequence__init(&mut msg.projected_maps_info, self.projected_maps_info.len()) };
let slice = unsafe { std::slice::from_raw_parts_mut(msg.projected_maps_info.data, msg.projected_maps_info.size)};
for (t,s) in slice.iter_mut().zip(&self.projected_maps_info) { s.copy_to_native(t);}
}
...
filename: std_msgs::msg::String::from_native(&msg.filename),
            ...
            fn copy_to_native(&self, msg: &mut Self::CStruct) {self.filename.copy_to_native(&mut msg.filename);
}
