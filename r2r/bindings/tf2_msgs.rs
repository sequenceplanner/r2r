...
source_time: builtin_interfaces::msg::Time::from_native(&msg.source_time),
timeout: builtin_interfaces::msg::Duration::from_native(&msg.timeout),
target_time: builtin_interfaces::msg::Time::from_native(&msg.target_time),
...
advanced: msg.advanced,
            ...
            fn copy_to_native(&self, msg: &mut Self::CStruct) {msg.target_frame.assign(&self.target_frame);
...
pub error: tf2_msgs::msg::TF2Error,
  ...
  Result {
transform: geometry_msgs::msg::TransformStamped::from_native(&msg.transform),
error: tf2_msgs::msg::TF2Error::from_native(&msg.error),
            ...
            fn copy_to_native(&self, msg: &mut Self::CStruct) {self.transform.copy_to_native(&mut msg.transform);
...
pub goal: tf2_msgs::action::LookupTransform::Goal,
            ...
            fn create_msg() -> *mut tf2_msgs__action__LookupTransform_SendGoal_Request {
                ...
                unsafe { tf2_msgs__action__LookupTransform_SendGoal_Request__create() }

            }

            fn destroy_msg(msg: *mut tf2_msgs__action__LookupTransform_SendGoal_Request) -> () {

                unsafe { tf2_msgs__action__LookupTransform_SendGoal_Request__destroy(msg) };
...
goal: tf2_msgs::action::LookupTransform::Goal::from_native(&msg.goal),
      }
    }
...
pub stamp: builtin_interfaces::msg::Time,
            ...
            fn create_msg() -> *mut tf2_msgs__action__LookupTransform_SendGoal_Response {
                ...
                unsafe { tf2_msgs__action__LookupTransform_SendGoal_Response__create() }

            }

            fn destroy_msg(msg: *mut tf2_msgs__action__LookupTransform_SendGoal_Response) -> () {

                unsafe { tf2_msgs__action__LookupTransform_SendGoal_Response__destroy(msg) };
    ...
    use super::super::super::super::*;
        ...
        impl WrappedServiceTypeSupport for Service {
            ...
            fn destroy_msg(msg: *mut tf2_msgs__action__LookupTransform_GetResult_Request) -> () {
                ...
                unsafe { tf2_msgs__action__LookupTransform_GetResult_Request__destroy(msg) };
...
pub result: tf2_msgs::action::LookupTransform::Result,
            ...
            fn create_msg() -> *mut tf2_msgs__action__LookupTransform_GetResult_Response {
                ...
                unsafe { tf2_msgs__action__LookupTransform_GetResult_Response__create() }

            }

            fn destroy_msg(msg: *mut tf2_msgs__action__LookupTransform_GetResult_Response) -> () {

                unsafe { tf2_msgs__action__LookupTransform_GetResult_Response__destroy(msg) };
  ...
  Response {
status: msg.status,
result: tf2_msgs::action::LookupTransform::Result::from_native(&msg.result),
      }
    }
...
pub feedback: tf2_msgs::action::LookupTransform::Feedback,
            ...
            fn destroy_msg(msg: *mut tf2_msgs__action__LookupTransform_FeedbackMessage) -> () {

                unsafe { tf2_msgs__action__LookupTransform_FeedbackMessage__destroy(msg) };
  ...
  FeedbackMessage {
goal_id: unique_identifier_msgs::msg::UUID::from_native(&msg.goal_id),
feedback: tf2_msgs::action::LookupTransform::Feedback::from_native(&msg.feedback),
      }
    }
