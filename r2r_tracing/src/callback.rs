    ...
    F: FnMut(M),
{
    ...
    /// Emits trace event attaching this `callback` to the `service`.
    ///
    ...
    /// Emits trace event attaching this `callback` to the `timer`.
    ///
    /// Wraps the callback to allow tracing the callback calls.
    ...
    /// Emits trace event attaching this `callback` to the `subscription`.
    ///
    /// Wraps the callback to allow tracing the callback calls.
